...
/* File Header                                                                */
/*----------------------------------------------------------------------------*/
//#define ALT_I2C_ADDR 1
#ifdef BUS_TYPE_SPI
	#define TX_PAGE_0		(0x00)
	#define TX_PAGE_1		(0x01)
	#define TX_PAGE_2		(0x02)
	#define TX_PAGE_3		(0x03)
	#define TX_PAGE_4		(0x04)
	#define TX_CBUS			(0x05)
	#define TX_PAGE_6		(0x06)
	#define TX_PAGE_7		(0x07)
	#define TX_PAGE_8		(0x08)
#else
	#ifdef SLAVE_ADDR_7BIT
		#ifndef ALT_I2C_ADDR
			#define TX_PAGE_0		(0x72 >> 1)
			#define TX_PAGE_1		(0x7A >> 1)
			#define TX_PAGE_2		(0x92 >> 1)
			#define TX_PAGE_3		(0x9A >> 1)
			#define TX_PAGE_4		(0xBA >> 1)
			#define TX_PAGE_6		(0xB2 >> 1)
			#define TX_PAGE_7		(0xC2 >> 1)
			#define TX_PAGE_8		(0xD2 >> 1)
		#else
			#define TX_PAGE_0		(0x76 >> 1)
			#define TX_PAGE_1		(0x7E >> 1)
			#define TX_PAGE_2		(0x96 >> 1)
			#define TX_PAGE_3		(0x9E >> 1)
			#define TX_PAGE_4		(0xBE >> 1)
			#define TX_PAGE_6		(0xB6 >> 1)
			#define TX_PAGE_7		(0xC6 >> 1)
			#define TX_PAGE_8		(0xD6 >> 1)
		#endif
	#define TX_CBUS			(0xC8 >> 1)
		...
		#else
			#define TX_PAGE_0		(0x76)
			#define TX_PAGE_1		(0x7E)
			#define TX_PAGE_2		(0x96)
			#define TX_PAGE_3		(0x9E)
			#define TX_PAGE_4		(0xBE)
			#define TX_CBUS			(0xCC)
			#define TX_PAGE_6		(0xB6)
			#define TX_PAGE_7		(0xC6)
			#define TX_PAGE_8		(0xD6)
		#endif
...
#define MSK_PAGE_3_TX_ZONE_CTL3_TX_ZONE		               (0x03 << 0)
