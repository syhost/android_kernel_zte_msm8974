...
typedef struct SI_PACK_THIS_STRUCT _MHL3_video_descriptor_t {
	MHL3_vdi_l_t	vdi_l;
	MHL3_vdi_h_t	vdi_h;
}MHL3_video_descriptor_t, *PMHL3_video_descriptor_t;
...
typedef struct SI_PACK_THIS_STRUCT _MHL_bits_per_pixel_fmt_data_t{
	...
	*/
	MHL3_bits_per_pixel_fmt_descriptor_t descriptors[5]; /* todo change this to 1 when WRITE_BURST OPTION is removed */
